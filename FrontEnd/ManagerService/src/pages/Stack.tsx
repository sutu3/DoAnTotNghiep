    ...
    return (
        <Card className="bg-white dark:bg-gray-900 rounded-xl text-gray-800 dark:text-gray-100 shadow-lg">
                            ...
                            >
                                {filledBins.map((bin) => {
                                    ...
                                    if (isLoaded) {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div
                                                    className="w-10 h-10 rounded-md border shadow-sm bg-yellow-400 hover:bg-yellow-500 cursor-pointer transition"
                                                />
                                            </ToolTipUI>
                                        );
                                    }
                                    ...
                                    return (
                                        <ToolTipUI
                                            key={bin.binId}
                                            content={isEmpty ? "Empty Bin" : `Free Bin - ${bin.binId}`}
                                        >
                                            <div
                                                className={`
            ...
            <CardFooter className="flex gap-6 mt-1 text-sm">
                <LegendBox color="bg-yellow-50 border border-gray-300" label="Free Place" />
                <LegendBox color="bg-yellow-400" label="Loaded Place" />
                <LegendBox color="bg-gray-200 border border-gray-400" label="Empty Bin" />
            </CardFooter>
        </Card>
    );
};
