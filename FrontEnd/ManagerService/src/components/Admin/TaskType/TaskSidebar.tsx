...
const TaskSidebar = ({data}:Prog) => {
    ...
    return (
        <div className="space-y-6">
            ...
            {/*            <span className="font-semibold">{data?.totalTasks||0}</span>*/}
            {/*        </div>*/}

            {/*        <div className="flex justify-between items-center">*/}
            {/*            <span className="text-gray-600 dark:text-gray-400">Đã hoàn thành:</span>*/}
            {/*            <span className="font-semibold text-green-600">{data?.totalTasksCompleted}</span>*/}
            {/*        </div>*/}

            {/*        <div className="flex justify-between items-center">*/}
            {/*            <span className="text-gray-600 dark:text-gray-400">Đang thực hiện:</span>*/}
            {/*            <span className="font-semibold text-blue-600">{data?.totalTaskPending}</span>*/}
            {/*        </div>*/}

            {/*        <div className="flex justify-between items-center">*/}
            {/*            <span className="text-gray-600 dark:text-gray-400">Chờ xử lý:</span>*/}
            {/*            <span className="font-semibold text-orange-600">{data?.totalTasksInProgress}</span>*/}
            {/*        </div>*/}
            ...
            {/*                <span className="font-medium">{(data?.totalTasksCompleted*data?.totalTasks)/100}</span>*/}
            {/*            </div>*/}
