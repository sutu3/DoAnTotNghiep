...
const StackSummaryPanel: React.FC<StackSummaryPanelProps> = ({ stack, stats }) => {
            ...
            tooltip: {
                callbacks: {
                    label: function(tooltipItem: any) {
                        ...
                        const totalValue = tooltipItem.dataset.data.reduce((sum: number, val: number) => sum + val, 0);
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg flex flex-col">
            ...
            <div>
                ...
                <Progress value={percent} className="h-3 rounded-full bg-gray-200 dark:bg-gray-700 accent-orange-500" />
            </div>
