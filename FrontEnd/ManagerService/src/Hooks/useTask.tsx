...
export const useGetStatsTask = (warehouse:string|null,taskType:string|null) => {
        ...
        const fetchUser = async () => {
            ...
            try {
                ...
                const response:ApiResponse<stats> = await fetchApi(
                    { method:"GET",
                        url:API_ROUTES.user.tasks(null).search().byTaskTypeNameAndWarehouse(warehouse,taskType).getStats,
